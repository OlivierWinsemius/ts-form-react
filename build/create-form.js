...
const createForm = (formProperties) => {
    const form = new react_form_1.ReactForm(formProperties);
    ...
    const FormProvider = ({ children }) => (react_1.default.createElement(react_form_provider_1.ReactFormProvider, { Context: FormContext, form: form }, children));
